...
CREATE TABLE employee_salary (
	...
	DATE DATE NOT NULL,
	fk_$employee_id INT NOT NULL,
	FOREIGN KEY (fk_$employee_id) REFERENCES employee(id)
);

CREATE TABLE employee_hobby (
	id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	fk_$employee_id INT,
	fk_$employee_hobby_id INT,
	FOREIGN KEY (fk_$employee_id) REFERENCES employee(id),
	FOREIGN KEY (fk_$employee_hobby_id) REFERENCES hobby(id)
);
...
INSERT INTO employee_salary (salary, DATE, fk_$employee_id)
...
INSERT INTO employee_hobby (fk_$employee_id, fk_$employee_hobby_id)
VALUE (1, 1);
